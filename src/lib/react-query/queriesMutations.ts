...
import { INewPost, INewUser, IUpdatePost, IUpdateUser } from "@/types/indes";
...
//because we are not fetching we are mutating an already fetched post// useMutation instead of query
